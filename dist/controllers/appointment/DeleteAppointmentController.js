...
var DeleteAppointmentController = /** @class */ (function () {
    function DeleteAppointmentController(deleteAppointmentService) {
        this.deleteAppointmentService = deleteAppointmentService;
    }
    DeleteAppointmentController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.deleteAppointmentService.execute({ id: request.params.id })];
                    case 1:
                        _a.sent();

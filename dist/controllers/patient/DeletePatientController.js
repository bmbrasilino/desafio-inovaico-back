...
var DeletePatientController = /** @class */ (function () {
    function DeletePatientController(deletePatientService) {
        this.deletePatientService = deletePatientService;
    }
    DeletePatientController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.deletePatientService.execute({ id: request.params.id })];
                    case 1:
                        _a.sent();

    ...
    CreateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findByEmail({ email: email })];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.usersRepository.create({ name: name, email: email, password: passwordHash })];
                    case 3:
                        _b.sent();
                        return [2 /*return*/];
                }
